<!--
  ...
  Path: skills/design-md/examples/DESIGN.md
  Fetched for local UI reference. Original is an example design system (Furniture Collections List).
  https://github.com/google-labs-code/stitch-skills/blob/main/skills/design-md/examples/DESIGN.md
-->
